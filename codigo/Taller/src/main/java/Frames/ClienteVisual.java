...
public class ClienteVisual extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Clientes");
        setLocation(new java.awt.Point(1250, 10));
        ...
        if (jTextField3.getText().matches("[0-9]*")&& jTextField3.getText().length()==9){
            if (!jDateChooser1.getDate().toString().isEmpty()){
                if (jTextField4.getText().matches("[0-9]*")){
                    try {
                        incluir.incluirCliente(jTextField1.getText(), jTextField2.getText(), jTextField3.getText(), (String)jComboBox1.getSelectedItem(), (String) jComboBox2.getSelectedItem(), (String) jComboBox3.getSelectedItem(), jDateChooser1.getDate().toString(), jTextField4.getText(), jTextField5.getText());
                ...
                JOptionPane.showMessageDialog(null, "La fecha se encuentra vacia", "Error", JOptionPane.WARNING_MESSAGE);
            }
        }else{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTextField6.getText().matches("[0-9]*")){
            try {
                new BD().eliminarCliente(jTextField6.getText());
            } catch (FileNotFoundException ex) {
                Logger.getLogger(ClienteVisual.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClienteVisual(null).setVisible(true);
            }
        });
    }
