...
public class RegistroServicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jFormattedTextCosto = new javax.swing.JTextField();
        ...
        jFormattedTextCosto.setMinimumSize(new java.awt.Dimension(125, 22));
        jFormattedTextCosto.setPreferredSize(new java.awt.Dimension(125, 22));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jTextFieldCaso, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(jFormattedTextCosto, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(this.tServicioComboBox.getSelectedIndex()==1){       //opcion de mecanica
            if(!this.jTextDesc.getText().isEmpty()&&!this.jTextProb.getText().isEmpty()&&!this.jFormattedTextCosto.getText().isEmpty()&&this.jDateChooser1.getDate()!=null&&this.jDateChooser2.getDate()!=null){
                ...
                bd.addService(new Servicio((String)jComboBoxVehicle.getSelectedItem(), this.jTextFieldCaso.getText(), this.jTextDesc.getText(), this.jTextProb.getText(),this.jFormattedTextCosto.getText(),this.jDateChooser1.getDate().toString(), this.jDateChooser2.getDate().toString()));
                this.dispose();
            }
            else{
            ...
            if(!this.jTextDesc.getText().isEmpty()&&this.jDateChooser1.getDate()!=null&&this.jDateChooser2.getDate()!=null){
                if(getSelectedChecks()!=null){
                     bd.addService(new Servicio(jComboBoxVehicle.getSelectedItem().toString(),jComboBoxUser.getSelectedItem().toString(),jTextDesc.getText(),getSelectedChecks(),jCheckBoxPoliza.isSelected(),jTextFieldCaso.getText(),jFormattedTextCosto.getText(),jDateChooser1.getDate().toString(),jDateChooser2.getDate().toString()));
                    this.dispose();
                    }
            }
            else{
    ...
    private javax.swing.JTextField jFormattedTextCosto;
